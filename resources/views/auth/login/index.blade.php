    ...
    <div class="container-fluid fullscreen">
                ...
                <div class="row">
                    ...
                    <form id="loginForm" class="form" action="/login" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control @error('emailLogin') is-invalid @enderror"
                                id="emailLogin" name="emailLogin" placeholder="name@example.com" autofocus required
                    ...
                    <form id="registerForm" class="form" style="display:none;" method="POST" action="/register">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="phonenum" name="phonenum"
                                placeholder="Phone Number" value="{{ old('phonenum') }}">
        ...
        <style>
            .bg1 {
                ...
                /* Ganti 'Assets/background.png' dengan path ke gambar yang ingin Anda gunakan */
