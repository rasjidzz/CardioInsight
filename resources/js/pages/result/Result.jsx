...
const Result = () => {
    ...
    return (
        <div className="result-container">
            <h1 className="result-highlight">{resultData.isPKV ? "Positive for Cardiovascular Disease" : "Negative for Cardiovascular Disease"}</h1>
            ...
            <div className="user-stats">
                <div className="stat-item">
                    ...
                    <p className={`stat-value ${resultData.cholesterolStatus}`}>{resultData.cholesterolStatus} ({resultData.cholesterolLevel} mg/dL)</p>
                </div>

                <div className="stat-item">
                    <h3>Glucose Level</h3>
                    <p className={`stat-value ${resultData.glucoseStatus}`}>{resultData.glucoseStatus} ({resultData.glucoseLevel} mg/dL)</p>
                </div>
            ...
            <div className="button-container">
                <button className="back-button" onClick={resultData.onBack}>Back</button>
                <button className="doctor-button" onClick={resultData.onRecommend}>Rekomendasi Dokter</button>
            </div>
        </div>
    );
};
